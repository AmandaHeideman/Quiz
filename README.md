...
* Du ska skriva en metod i en lämplig klass som heter correct (eller liknande) och som tar emot minst två parametrar:
  1. En HTML-collection (eller liknande, array, NodeList etc) som innehåller de svar användaren har kryssat i.
  2. En array, ett objekt eller liknande , som innehåller de korrekta svaren.
...
Redovisning sker genom ett kort, individuellt möte den 6/7 oktober, troligen på Zoom. Återkommer senare med ett schema där man får boka sin tid. Du ska också lämna in ett publikt github-repo.
